        ...
        <div className="w-[90vw] p-[3vh] rounded-2xl shadow-2xl shadow-[#5ec7ff] bg-white">
          <div className="flex align-middle">
            ...
            <div className="text-left p-[2vh] m-[4vh]">
              <h1 className="pb-[2vh]">SOURCE&apos;S NAME HERE</h1>
              <p className="pb-[2vh]">
                This section will have a short summary of the source and what I
                learned, as well as a page link to read more about the interview
                in depth. Next to each description will be an image of the
                interviewee. Lorem ipsum dolor sit amet, consectetur adipiscing
